import socket, http, socketserver, threading, urllib
...
"""
NOTE: This server is only loosely tested and therefore prone to crumbling...if you have 
to restart after a crash and you a port in use error, either wait about 30 seconds 
or just change the port here and in client to something different, e.g., 8001
"""
def start_httpd():
    """
    Adopted from week 7 lecture notes
    """
    PORT = 8000
...
if __name__ == '__main__':
    ...
    worry about what's going on too much! Just know that we are using threading
