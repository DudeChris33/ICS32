...
class Body(tk.Frame):
    ...
    def _draw(self):
        ...
        self.message_editor = tk.Text(message_frame, width=0, height=0)
        self.message_editor.pack(fill=tk.BOTH, side=tk.LEFT, expand=True, padx=2, pady=0)
...
class Footer(tk.Frame):
    def __init__(self, root, add_callback=None, delete_callback=None):
        tk.Frame.__init__(self, root)
        self.root = root
        self._add_callback = MainApp.add_clicked
        self._delete_callback = MainApp.delete_clicked
        self._draw()
    ...
    def _draw(self):
        self.delete_button = tk.Button(master=self, command=self.delete_click, text="Delete", width=20)
        self.delete_button.pack(fill=tk.BOTH, side=tk.RIGHT, padx=5, pady=5)
        self.add_button = tk.Button(master=self, command=self.add_click, text="Add", width=20)
